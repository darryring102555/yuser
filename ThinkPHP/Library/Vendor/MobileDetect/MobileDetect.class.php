...
class MobileDetect{
    const DETECTION_TYPE_MOBILE     = 'mobile'; //移动端类型
    const DETECTION_TYPE_EXTENDED   = 'extended'; //扩展检测类型
    const VER                       = '([\w._\+]+)'; //常用正则表达式提取版本
    const MOBILE_GRADE_A            = 'A'; //顶级设备
    const MOBILE_GRADE_B            = 'B'; //中级设备
    const MOBILE_GRADE_C            = 'C'; //低级设备
    const VERSION                   = '2.8.16'; //当前版本的版本号
    const VERSION_TYPE_STRING       = 'text'; //返回版本类型字符串
    const VERSION_TYPE_FLOAT        = 'float'; //返回版本类型
    protected $cache = array(); //匹配缓存
    protected $userAgent = null; //用于匹配的值
    protected $httpHeaders = array(); //http头
    protected $cloudfrontHeaders = array();
    protected $matchingRegex = null; //正则表达式
    protected $matchesArray = null;
    protected $detectionType = self::DETECTION_TYPE_MOBILE; //探测类型,使用self::DETECTION_TYPE_MOBILE或扩展类型self::DETECTION_TYPE_EXTENDED
    protected static $mobileHeaders = array( //移动端消息头
    ...
    protected static $brandName = array(
        'iPhone' =>array('en-us'=>'iPhone','zh-cn'=>'苹果'),
        'BlackBerry'    => array('en-us'=>'BlackBerry','zh-cn'=>'黑莓'),
        'HTC'           => array('en-us'=>'HTC','zh-cn'=>'HTC'),
        'Nexus'         => array('en-us'=>'Nexus','zh-cn'=>'Nexus'),
        'Dell'          => array('en-us'=>'Dell','zh-cn'=>'戴尔'),
        'Motorola'      => array('en-us'=>'Motorola','zh-cn'=>'摩托罗拉'),
        'Samsung'       => array('en-us'=>'Samsung','zh-cn'=>'三星'),
        'LG'            => array('en-us'=>'LG','zh-cn'=>'LG'),
        'Sony'          => array('en-us'=>'Sony','zh-cn'=>'索尼'),
        'Asus'          => array('en-us'=>'Asus','zh-cn'=>'华硕'),
        'Micromax'      => array('en-us'=>'Micromax','zh-cn'=>'Micromax'),
        'Palm'          => array('en-us'=>'Palm','zh-cn'=>'Palm'),
        'Vertu'         => array('en-us'=>'Vertu','zh-cn'=>'Vertu'),
        'Pantech'       => array('en-us'=>'Pantech','zh-cn'=>'泛泰'),
        'Fly'           => array('en-us'=>'Fly','zh-cn'=>'Fly'),
        'Wiko'          => array('en-us'=>'Wiko','zh-cn'=>'Wiko'),
        'iMobile'       => array('en-us'=>'iMobile','zh-cn'=>'iMobile'),
        'SimValley'     => array('en-us'=>'SimValley','zh-cn'=>'SimValley'),
        'Wolfgang'      => array('en-us'=>'Wolfgang','zh-cn'=>'Wolfgang'),
        'Alcatel'       => array('en-us'=>'Alcatel','zh-cn'=>'阿尔卡特'),
        'Nintendo'      => array('en-us'=>'Nintendo','zh-cn'=>'Nintendo'),
        'Amoi'          => array('en-us'=>'Amoi','zh-cn'=>'夏新'),
        'INQ'           => array('en-us'=>'INQ','zh-cn'=>'INQ'),
        'MeiZu'           => array('en-us'=>'MeiZu','zh-cn'=>'魅族'),
        'XiaoMi'           => array('en-us'=>'XiaoMi','zh-cn'=>'小米'),
        'GenericPhone'  => array('en-us'=>'GenericPhone','zh-cn'=>'GenericPhone')
    );
