define(['jquery','common','validate_cn'
    ,'uploadify'    ,'ztree'    ,'wdatePicker'    ,'ueditor_cn'    ,'icheck'    ,'ace_elements'    ,'colorpicker'    ,'select2'    ],function(j,f,v
    ,u    ,z    ,w    ,UE    ,icheck    ,ace    ,color    ,select    ){
    ...
    bind.verify = function(){
        j("#edit").validate({
            rules: {
                name:{required:true,rangelength:[6,18]},parent_id:{number:true},deep:{number:true}            },
            messages: {
                name:{"required":"true","rangelength":"[6,18]"},parent_id:{"number":"true"},deep:{"number":"true"}            },
